...
import Button9211101 from "../../../public/assets/Button9211101.png"
    ...
    return (
        <div className="w-[1920px] h-[829px] bg-[#043873] flex justify-center items-center">
            <div className="w-[656px] h-[361px] text-white relative" >
                ...
                <button className="w-[219px] h-[63px] absolute inset bottom-0 left-0 rounded-lg"><Image src={Button9211101} alt=""/></button>
